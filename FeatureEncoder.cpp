...
uint64_t FeatureEncoder::genCodePP(uint64_t temp, uint64_t p1, uint64_t p2) {
	return (((p1 << midOff) | p2) << tempOff) | temp;
}
...
uint64_t FeatureEncoder::genCodePPP(uint64_t temp, uint64_t p1, uint64_t p2, uint64_t p3) {
	return (((((p1 << midOff) | p2) << midOff) | p3) << tempOff) | temp;
}

uint64_t FeatureEncoder::genCodePPW(uint64_t temp, uint64_t p1, uint64_t p2, uint64_t w1) {
	return (((((w1 << midOff) | p1) << midOff) | p2) << tempOff) | temp;
}
...
uint64_t FeatureEncoder::genCodePPPP(uint64_t temp, uint64_t p1, uint64_t p2, uint64_t p3, uint64_t p4) {
	return (((((((p1 << midOff) | p2) << midOff) | p3) << midOff) | p4) << tempOff) | temp;
}

uint64_t FeatureEncoder::genCodePPPW(uint64_t temp, uint64_t p1, uint64_t p2, uint64_t p3, uint64_t w1) {
	return (((((((w1 << midOff) | p1) << midOff) | p2) << midOff) | p3) << tempOff) | temp;
}
...
uint64_t FeatureEncoder::genCodePFF(uint64_t temp, uint64_t p1, uint64_t f1, uint64_t f2) {
	return (((((p1 << flagOff) | f1) << flagOff) | f2) << tempOff) | temp;
}
